...
public abstract class LbIWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static LbIWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(LbIWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<LbIDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<LbIDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<LbIDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<LbIDbContext, Task<T>> func)
    {
        T result;
